 ...
 * 404로 돌려보낸다. notFound()에 맡기면 응답 코드가 200으로 나가서
...
function Section({
  ...
  return (
    <Reveal>
      <section>
        <h2 className="mb-8 text-xl font-bold tracking-tight">{title}</h2>
        {children}
      </section>
    </Reveal>
  );
    ...
    <Container wide>
      <div className="flex flex-col gap-16 pb-6">
        ...
        {project!.architecture && (
          <Section title="구조와 데이터 흐름">
            <ArchitectureDiagram architecture={project!.architecture} />
          </Section>
        )}

        {project!.features && project!.features.length > 0 && (
          <Section title="직접 설계하고 구현한 것">
